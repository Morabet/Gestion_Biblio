...
public class User_modelClass {

    private String apogee,nom,prenom,email,password,tele,statut;
    private int num_reserver,num_emprunter;


    public User_modelClass(String apogee, String nom, String prenom, String email, String password, String tele, String statut, int num_reserver, int num_emprunter) {
        this.apogee = apogee;
        this.nom = nom;
        this.prenom = prenom;
        this.email = email;
    ...
    public User_modelClass(String apogee, String nom, String prenom) {
        this.apogee = apogee;
        this.nom = nom;
        this.prenom = prenom;
    }
